...
namespace BeerTap.WebApi.Infrastructure
{
    ...
    {
        static IApiContainer _container;
        ...
        public static ICreatePingResource ResolvePingFactory()
        {
            return _container.Resolve<ICreatePingResource>();
        }
        ...
        static HypermediaConfiguration SetConfiguration(HttpConfiguration config, Action<HttpConfiguration> postConfigure)
        {
            ...
            var hconfig = new HypermediaConfiguration
            {
                ...
                ApiRelativePath = new Uri("v1", UriKind.Relative),

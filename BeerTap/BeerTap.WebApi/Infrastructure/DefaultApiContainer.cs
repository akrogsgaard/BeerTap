...
using BeerTap.ApiServices.Office;
...
namespace BeerTap.WebApi.Infrastructure
{
    public class DefaultApiContainer : ApiContainer
    {
        ...
        readonly Assembly _apiDomainServicesAssembly = typeof(OfficeApiService).Assembly;
        readonly Assembly _persistenceAssembly = typeof(BeerTapContext).Assembly;
        readonly Assembly _domainServicesAssembly = typeof(IOfficeRepository).Assembly;
        ...
        protected override void RegisterCustomDependencies()
        {
            ...
            _windsorContainer
                .Install(new IWindsorInstaller[]
				         {
						    new LoggingDependenciesInstaller(),
					        new DomainServicesInstaller(_domainServiceResolver, _apiDomainServicesAssembly, _apiDomainServicesAssembly),
					        new ResourceMapperInstaller(new [] {ApiAppServicesAssembly, _persistenceAssembly, _domainServicesAssembly}),
        ...
        {
            return
                _windsorContainer.Resolve<ApiSecurityContextProvidingHandler<BeerTapUser, NullUserContext>>();
        }
